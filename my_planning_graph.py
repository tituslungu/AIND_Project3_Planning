...
class PlanningGraph():
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        act1 = node_a1.action
        act2 = node_a2.action
        for effect1 in act1.effect_add:
            for effect2 in act2.effect_rem:
                if effect1 == effect2:
                    return True

        for effect1 in act1.effect_rem:
            for effect2 in act2.effect_add:
                if effect1 == effect2:
                    return True
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        act2 = node_a2.action
        for effect1 in act1.effect_add:
            for precond2 in act2.precond_neg:
                if effect1 == precond2:
                    return True

        for precond1 in act1.precond_neg:
            for effect2 in act2.effect_add:
                if precond1 == effect2:
                    return True

        for effect1 in act1.effect_rem:
            for precond2 in act2.precond_pos:
                if effect1 == precond2:
                    return True

        for precond1 in act1.precond_pos:
            for effect2 in act2.effect_rem:
                if precond1 == effect2:
                    return True
    ...
    def competing_needs_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        for parent1 in node_a1.parents:
            for parent2 in node_a2.parents:
                if (parent1.is_mutex(parent2) or parent2.is_mutex(parent1)):
                    return True
    ...
    def h_levelsum(self) -> int:
        ...
        for goal in self.problem.goal:
            ...
            for level in self.s_levels:
                level_index += 1
                for state in level:
                    if (goal == state.symbol) and (goal not in added_goals) and (state.is_pos):
